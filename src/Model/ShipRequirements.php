...
/**
 * ShipRequirements Class Doc Comment
 *
 ...
 */
class ShipRequirements implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ShipRequirements';
    ...
    */
     ...
     * Sets power
     *
     * @param int|null $power The amount of power required from the reactor.
     *
     * @return $this
     */
     ...
     * Sets crew
     *
     * @param int|null $crew The number of crew required for operation.
     *
     * @return $this
     */
    public function setCrew(?int $crew): static
    {
        if (is_null($crew)) {
     ...
     * Sets slots
     *
     * @param int|null $slots The number of module slots required for installation.
     *
     * @return $this
     */
