...
/**
 * ScannedWaypoint Class Doc Comment
 *
 ...
 */
class ScannedWaypoint implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ScannedWaypoint';
    ...
    */
    ...
    public function setSymbol(string $symbol): static
    {
        ...
        if ((mb_strlen($symbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $symbol when calling ScannedWaypoint., must be bigger than or equal to 1.');
        }
    ...
    public function setSystemSymbol(string $systemSymbol): static
    {
        ...
        if ((mb_strlen($systemSymbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $systemSymbol when calling ScannedWaypoint., must be bigger than or equal to 1.');
        }
     ...
     * Sets orbitals
     *
     * @param \OpenAPI\Client\Model\WaypointOrbital[] $orbitals List of waypoints that orbit this waypoint.
     *
     * @return $this
     */
