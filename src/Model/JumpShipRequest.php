...
/**
 * JumpShipRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class JumpShipRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'jump_ship_request';
    ...
    */
     ...
     * Sets waypointSymbol
     *
     * @param string $waypointSymbol The symbol of the waypoint to jump to. The destination must be a connected waypoint.
     *
     * @return $this
     */
