...
/**
 * ShipNavRouteWaypoint Class Doc Comment
 *
 ...
 */
class ShipNavRouteWaypoint implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ShipNavRouteWaypoint';
    ...
    */
    ...
    public function setSymbol(string $symbol): static
    {
        ...
        if ((mb_strlen($symbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $symbol when calling ShipNavRouteWaypoint., must be bigger than or equal to 1.');
        }
    ...
    public function setSystemSymbol(string $systemSymbol): static
    {
        ...
        if ((mb_strlen($systemSymbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $systemSymbol when calling ShipNavRouteWaypoint., must be bigger than or equal to 1.');
        }
