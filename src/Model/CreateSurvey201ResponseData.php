...
/**
 * CreateSurvey201ResponseData Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateSurvey201ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_survey_201_response_data';
    ...
    protected static array $openAPITypes = [
        ...
        'surveys' => '\OpenAPI\Client\Model\Survey[]'
    ];
    ...
    */
     ...
     * Gets surveys
     *
     * @return \OpenAPI\Client\Model\Survey[]
     */
     ...
     * Sets surveys
     *
     * @param \OpenAPI\Client\Model\Survey[] $surveys Surveys created by this action.
     *
     * @return $this
     */
    public function setSurveys(array $surveys): static
    {
        if (is_null($surveys)) {
