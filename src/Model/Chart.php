...
class Chart implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Chart';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('submittedBy', $data ?? [], null);
        $this->setIfExists('submittedOn', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['waypointSymbol']) && (mb_strlen($this->container['waypointSymbol']) < 1)) {
     ...
     * Sets waypointSymbol
     *
     * @param string|null $waypointSymbol The symbol of the waypoint.
     *
     * @return $this
     */
    public function setWaypointSymbol(?string $waypointSymbol): static
    {
        ...
        if ((mb_strlen($waypointSymbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $waypointSymbol when calling Chart., must be bigger than or equal to 1.');
        }
     ...
     * Sets submittedBy
     *
     * @param string|null $submittedBy The agent that submitted the chart for this waypoint.
     *
     * @return $this
     */
    public function setSubmittedBy(?string $submittedBy): static
    {
        if (is_null($submittedBy)) {
            throw new InvalidArgumentException('non-nullable submittedBy cannot be null');
        }
    ...
    {
        return $this->container['submittedOn'];
    }

    /**
     * Sets submittedOn
     *
     * @param \DateTime|null $submittedOn The time the chart for this waypoint was submitted.
     *
     * @return $this
     */
    public function setSubmittedOn(?\DateTime $submittedOn): static
    {
        if (is_null($submittedOn)) {
            throw new InvalidArgumentException('non-nullable submittedOn cannot be null');
        }
        $this->container['submittedOn'] = $submittedOn;
