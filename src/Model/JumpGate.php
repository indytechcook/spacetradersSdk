 ...
 */
class JumpGate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'JumpGate';
    ...
    */
    ...
    public function setSymbol(string $symbol): static
    {
        ...
        if ((mb_strlen($symbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $symbol when calling JumpGate., must be bigger than or equal to 1.');
        }
     ...
     * Sets connections
     *
     * @param string[] $connections All the gates that are connected to this waypoint.
     *
     * @return $this
     */
