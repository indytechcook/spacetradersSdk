...
class ScannedSystem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ScannedSystem';
    ...
    */
     ...
     * Sets sectorSymbol
     *
     * @param string $sectorSymbol Symbol of the system's sector.
     *
     * @return $this
     */
    public function setSectorSymbol(string $sectorSymbol): static
    {
        ...
        if ((mb_strlen($sectorSymbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $sectorSymbol when calling ScannedSystem., must be bigger than or equal to 1.');
        }
