...
class MarketTransaction implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MarketTransaction';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (($this->container['pricePerUnit'] < 0)) {
            $invalidProperties[] = "invalid value for 'pricePerUnit', must be bigger than or equal to 0.";
        }
    ...
    public function setWaypointSymbol(string $waypointSymbol): static
    {
        ...
        if ((mb_strlen($waypointSymbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $waypointSymbol when calling MarketTransaction., must be bigger than or equal to 1.');
        }
     ...
     * Sets shipSymbol
     *
     * @param string $shipSymbol The symbol of the ship that made the transaction.
     *
     * @return $this
     */
     ...
     * Sets tradeSymbol
     *
     * @param string $tradeSymbol The symbol of the trade good.
     *
     * @return $this
     */
     ...
     * Sets pricePerUnit
     *
     * @param int $pricePerUnit The price per unit of the transaction.
     *
     * @return $this
     */
    public function setPricePerUnit(int $pricePerUnit): static
    {
        ...
        if (($pricePerUnit < 0)) {
            throw new InvalidArgumentException('invalid value for $pricePerUnit when calling MarketTransaction., must be bigger than or equal to 0.');
        }
     ...
     * Sets totalPrice
     *
     * @param int $totalPrice The total price of the transaction.
     *
     * @return $this
     */
    public function setTotalPrice(int $totalPrice): static
    {
        ...
        if (($totalPrice < 0)) {
            throw new InvalidArgumentException('invalid value for $totalPrice when calling MarketTransaction., must be bigger than or equal to 0.');
        }
