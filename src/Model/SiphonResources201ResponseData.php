...
/**
 * SiphonResources201ResponseData Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SiphonResources201ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'siphon_resources_201_response_data';
    ...
    protected static array $openAPITypes = [
        ...
        'siphon' => '\OpenAPI\Client\Model\Siphon',
        'cargo' => '\OpenAPI\Client\Model\ShipCargo',
        'events' => '\OpenAPI\Client\Model\ExtractResources201ResponseDataEventsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('siphon', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['siphon'] === null) {
            $invalidProperties[] = "'siphon' can't be null";
        }
     ...
     * Gets siphon
     *
     * @return \OpenAPI\Client\Model\Siphon
     */
    public function getSiphon(): \OpenAPI\Client\Model\Siphon
    {
        return $this->container['siphon'];
    }

    /**
     * Sets siphon
     *
     * @param \OpenAPI\Client\Model\Siphon $siphon siphon
     *
     * @return $this
     */
    public function setSiphon(\OpenAPI\Client\Model\Siphon $siphon): static
    {
        if (is_null($siphon)) {
            throw new InvalidArgumentException('non-nullable siphon cannot be null');
        }
        $this->container['siphon'] = $siphon;
     ...
     * Gets events
     *
     * @return \OpenAPI\Client\Model\ExtractResources201ResponseDataEventsInner[]
     */
     ...
     * Sets events
     *
     * @param \OpenAPI\Client\Model\ExtractResources201ResponseDataEventsInner[] $events events
     *
     * @return $this
     */
