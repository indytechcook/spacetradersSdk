...
/**
 * GetStatus200ResponseStats Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetStatus200ResponseStats implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_status_200_response_stats';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['ships'] === null) {
            $invalidProperties[] = "'ships' can't be null";
        }
     ...
     * Sets agents
     *
     * @param int $agents Number of registered agents in the game.
     *
     * @return $this
     */
     ...
     * Sets ships
     *
     * @param int $ships Total number of ships in the game.
     *
     * @return $this
     */
    public function setShips(int $ships): static
    {
        if (is_null($ships)) {
     ...
     * Sets systems
     *
     * @param int $systems Total number of systems in the game.
     *
     * @return $this
     */
    public function setSystems(int $systems): static
    {
        if (is_null($systems)) {
     ...
     * Sets waypoints
     *
     * @param int $waypoints Total number of waypoints in the game.
     *
     * @return $this
     */
    public function setWaypoints(int $waypoints): static
    {
