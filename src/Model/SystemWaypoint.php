...
/**
 * SystemWaypoint Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SystemWaypoint implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SystemWaypoint';
    ...
    */
    ...
    public function setSymbol(string $symbol): static
    {
        ...
        if ((mb_strlen($symbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $symbol when calling SystemWaypoint., must be bigger than or equal to 1.');
        }
    ...
    public function setOrbits(?string $orbits): static
    {
        ...
        if ((mb_strlen($orbits) < 1)) {
            throw new InvalidArgumentException('invalid length for $orbits when calling SystemWaypoint., must be bigger than or equal to 1.');
        }
