...
/**
 * ShipRefine201ResponseData Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ShipRefine201ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Ship_Refine_201_Response_data';
    ...
    protected static array $openAPITypes = [
        ...
        'produced' => '\OpenAPI\Client\Model\ShipRefine201ResponseDataProducedInner[]',
        'consumed' => '\OpenAPI\Client\Model\ShipRefine201ResponseDataProducedInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['produced'] === null) {
            $invalidProperties[] = "'produced' can't be null";
        }
     ...
     * Gets produced
     *
     * @return \OpenAPI\Client\Model\ShipRefine201ResponseDataProducedInner[]
     */
     ...
     * Sets produced
     *
     * @param \OpenAPI\Client\Model\ShipRefine201ResponseDataProducedInner[] $produced Goods that were produced by this refining process.
     *
     * @return $this
     */
    public function setProduced(array $produced): static
    {
        if (is_null($produced)) {
            throw new InvalidArgumentException('non-nullable produced cannot be null');
        }
     ...
     * Sets consumed
     *
     * @param \OpenAPI\Client\Model\ShipRefine201ResponseDataProducedInner[] $consumed Goods that were consumed during this refining process.
     *
     * @return $this
     */
    public function setConsumed(array $consumed): static
    {
        if (is_null($consumed)) {
