...
class ScannedShip implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ScannedShip';
    ...
    */
     ...
     */
    public function getFrame(): ?\OpenAPI\Client\Model\ScannedShipFrame
    {
     ...
     * @return $this
     */
    public function setFrame(?\OpenAPI\Client\Model\ScannedShipFrame $frame): static
    {
        if (is_null($frame)) {
     ...
     */
    public function getReactor(): ?\OpenAPI\Client\Model\ScannedShipReactor
    {
     ...
     * @return $this
     */
    public function setReactor(?\OpenAPI\Client\Model\ScannedShipReactor $reactor): static
    {
        if (is_null($reactor)) {
     ...
     */
    public function getEngine(): \OpenAPI\Client\Model\ScannedShipEngine
    {
     ...
     * @return $this
     */
    public function setEngine(\OpenAPI\Client\Model\ScannedShipEngine $engine): static
    {
        if (is_null($engine)) {
