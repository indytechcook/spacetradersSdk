...
/**
 * RepairTransaction Class Doc Comment
 *
 ...
 */
class RepairTransaction implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RepairTransaction';
    ...
    */
    ...
    public function setWaypointSymbol(string $waypointSymbol): static
    {
        ...
        if ((mb_strlen($waypointSymbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $waypointSymbol when calling RepairTransaction., must be bigger than or equal to 1.');
        }
    ...
    public function setTotalPrice(int $totalPrice): static
    {
        ...
        if (($totalPrice < 0)) {
            throw new InvalidArgumentException('invalid value for $totalPrice when calling RepairTransaction., must be bigger than or equal to 0.');
        }
