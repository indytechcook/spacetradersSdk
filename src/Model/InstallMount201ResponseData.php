...
/**
 * InstallMount201ResponseData Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InstallMount201ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Install_Mount_201_Response_data';
    ...
    */
     ...
     * Sets mounts
     *
     * @param \OpenAPI\Client\Model\ShipMount[] $mounts List of installed mounts after the installation of the new mount.
     *
     * @return $this
     */
