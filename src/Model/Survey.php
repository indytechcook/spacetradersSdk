...
class Survey implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Survey';
    ...
    protected static array $openAPITypes = [
        'signature' => 'string',
        'symbol' => 'string',
        'deposits' => '\OpenAPI\Client\Model\SurveyDeposit[]',
        'expiration' => '\DateTime',
        'size' => 'string'
    ];
    ...
    public const SIZE_MODERATE = 'MODERATE';
    ...
    */
     ...
     * Sets signature
     *
     * @param string $signature A unique signature for the location of this survey. This signature is verified when attempting an extraction using this survey.
     *
     * @return $this
     */
    public function setSignature(string $signature): static
    {
        ...
        if ((mb_strlen($signature) < 1)) {
            throw new InvalidArgumentException('invalid length for $signature when calling Survey., must be bigger than or equal to 1.');
        }
     ...
     * Sets symbol
     *
     * @param string $symbol The symbol of the waypoint that this survey is for.
     *
     * @return $this
     */
    public function setSymbol(string $symbol): static
    {
        ...
        if ((mb_strlen($symbol) < 1)) {
            throw new InvalidArgumentException('invalid length for $symbol when calling Survey., must be bigger than or equal to 1.');
        }
     ...
     * Gets deposits
     *
     * @return \OpenAPI\Client\Model\SurveyDeposit[]
     */
     ...
     * Sets deposits
     *
     * @param \OpenAPI\Client\Model\SurveyDeposit[] $deposits A list of deposits that can be found at this location. A ship will extract one of these deposits when using this survey in an extraction request. If multiple deposits of the same type are present, the chance of extracting that deposit is increased.
     *
     * @return $this
     */
     ...
     * Sets expiration
     *
     * @param \DateTime $expiration The date and time when the survey expires. After this date and time, the survey will no longer be available for extraction.
     *
     * @return $this
     */
     ...
     * Sets size
     *
     * @param string $size The size of the deposit. This value indicates how much can be extracted from the survey before it is exhausted.
     *
     * @return $this
     */
