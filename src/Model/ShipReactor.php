 ...
 */
class ShipReactor implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ShipReactor';
    ...
    public const SYMBOL_SOLAR_I = 'REACTOR_SOLAR_I';
    public const SYMBOL_FUSION_I = 'REACTOR_FUSION_I';
    public const SYMBOL_FISSION_I = 'REACTOR_FISSION_I';
    public const SYMBOL_CHEMICAL_I = 'REACTOR_CHEMICAL_I';
    public const SYMBOL_ANTIMATTER_I = 'REACTOR_ANTIMATTER_I';
    ...
    public function getSymbolAllowableValues()
    {
        return [
            self::SYMBOL_SOLAR_I,
            self::SYMBOL_FUSION_I,
            self::SYMBOL_FISSION_I,
            self::SYMBOL_CHEMICAL_I,
            self::SYMBOL_ANTIMATTER_I,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('powerOutput', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['powerOutput'] === null) {
            $invalidProperties[] = "'powerOutput' can't be null";
        }
        if (($this->container['powerOutput'] < 1)) {
            $invalidProperties[] = "invalid value for 'powerOutput', must be bigger than or equal to 1.";
        }
     ...
     * Sets symbol
     *
     * @param string $symbol Symbol of the reactor.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the reactor.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Description of the reactor.
     *
     * @return $this
     */
    ...
    public function setCondition(float $condition): static
    {
        ...
        if (($condition > 1)) {
            throw new InvalidArgumentException('invalid value for $condition when calling ShipReactor., must be smaller than or equal to 1.');
        }
        if (($condition < 0)) {
            throw new InvalidArgumentException('invalid value for $condition when calling ShipReactor., must be bigger than or equal to 0.');
        }
    ...
    public function setIntegrity(float $integrity): static
    {
        ...
        if (($integrity > 1)) {
            throw new InvalidArgumentException('invalid value for $integrity when calling ShipReactor., must be smaller than or equal to 1.');
        }
        if (($integrity < 0)) {
            throw new InvalidArgumentException('invalid value for $integrity when calling ShipReactor., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['powerOutput'];
    }

    /**
     * Sets powerOutput
     *
     * @param int $powerOutput The amount of power provided by this reactor. The more power a reactor provides to the ship, the lower the cooldown it gets when using a module or mount that taxes the ship's power.
     *
     * @return $this
     */
    public function setPowerOutput(int $powerOutput): static
    {
        if (is_null($powerOutput)) {
            throw new InvalidArgumentException('non-nullable powerOutput cannot be null');
        }

        if (($powerOutput < 1)) {
            throw new InvalidArgumentException('invalid value for $powerOutput when calling ShipReactor., must be bigger than or equal to 1.');
        }

        $this->container['powerOutput'] = $powerOutput;
